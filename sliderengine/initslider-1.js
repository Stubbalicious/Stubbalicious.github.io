jQuery(document).ready(function(){
    ...
    jQuery("#amazingslider-1").amazingslider({
        ...
        descriptioncss:"display:block; position:relative; font:12px \"Lobster\",\"Lucida Grande\",sans-serif,Arial; color:#fff; margin-top:8px;",
        navplaypauseimage:"navplaypause-28-28-0.png",
        backgroundimagetop:-25,
        timercolor:"#ffffff",
        ...
        titlecss:"display:block; position:relative; font:bold 14px \"UnifrakturCook\",\"Lucida Grande\",sans-serif,Arial; color:#fff;",
        ribbonimagey:0,
        ribbonimagex:0,
        ...
        backgroundimage:"pirate-map.jpg",
        navposition:"right",
